...
# original seq= real, actor_youtube, 
"""
...
if __name__ == '__main__':
    ...
    if dataset_name == 'FaceForensics++':
        sub_dataset_names = [
                        "real/actors/train", "real/actors/test", "real/actors/val",
                        "real/youtube/train", "real/youtube/test", "real/youtube/val",
                        "fake/deepfakedetection/train", "fake/deepfakedetection/test", "fake/deepfakedetection/val",
                        "fake/face2face/train", "fake/face2face/test", "fake/face2face/val",
                        "fake/faceshifter/train", "fake/faceshifter/test", "fake/faceshifter/val",
                        "fake/faceswap/train", "fake/faceswap/test", "fake/faceswap/val",
                        "fake/neuraltextures/train", "fake/neuraltextures/test", "fake/neuraltextures/val"]
